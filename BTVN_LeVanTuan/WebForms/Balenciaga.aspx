...
<%@ Page Title="" Language="C#" MasterPageFile="~/Sites/Site1.Master" AutoEventWireup="true" CodeBehind="Balenciaga.aspx.cs" Inherits="BTVN_LeVanTuan.WebForms.Balenciaga" %>
...
footer p {
    ...
    .header-main__menu-left li a[href='Balenciaga.aspx']:visited {
        color: red;
    }
  ...
  <div class="header-main__banner">
    ...
    <main>
        <div class="title-content">
          <h3 class="title-content__product">Giày Balenciaga</h3>
