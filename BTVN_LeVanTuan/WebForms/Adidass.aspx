...
<%@ Page Title="" Language="C#" MasterPageFile="~/Sites/Site1.Master" AutoEventWireup="true" CodeBehind="Adidass.aspx.cs" Inherits="BTVN_LeVanTuan.WebForms.Adidass" %>
...
/* ----------- End Footer ---------- */
    .header-main__menu-left li a[href='Adidass.aspx']:visited {
        color: red;
    }
  ...
  <div class="header-main__banner">
    ...
    <main>
        <div class="title-content">
          <h3 class="title-content__product">Giày Adidas cao cấp</h3>           
