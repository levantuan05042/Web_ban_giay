...
<%@ Page Title="" Language="C#" MasterPageFile="~/Sites/Site1.Master"  AutoEventWireup="true" CodeBehind="Khac.aspx.cs" Inherits="BTVN_LeVanTuan.WebForms.Khac" %>
...
/* ----------- End Footer ---------- */
.header-main__menu-left li a[href='Khac.aspx']:visited {
    color: red;
}
  ...
  <div class="header-main__banner">
    ...
    <main>
        <div class="title-content">
          <h3 class="title-content__product">Sản phẩm khác</h3>         
