...
<%@ Page Title="" Language="C#" MasterPageFile="~/Sites/Site1.Master"  AutoEventWireup="true" CodeBehind="Nike.aspx.cs" Inherits="BTVN_LeVanTuan.WebForms.Nike" %>
...
/* ----------- End Footer ---------- */
.header-main__menu-left li a[href='Nike.aspx']:visited {
    color: red;
}
  ...
  <div class="header-main__banner">
    ...
    <main>
        <div class="title-content">
          <h3 class="title-content__product">Giày Nike cao cấp</h3>         
