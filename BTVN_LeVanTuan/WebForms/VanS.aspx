...
<%@ Page Title="" Language="C#" MasterPageFile="~/Sites/Site1.Master" AutoEventWireup="true" CodeBehind="VanS.aspx.cs" Inherits="BTVN_LeVanTuan.WebForms.VanS" %>
...
footer p {
    ...
    color: white;
    font-weight: 600;
    font-style: italic;.header-main__menu-left li a[href='VanS.aspx']:visited {
    color: red;
}
    font-size: 16px;
}
/* ----------- End Footer ---------- */
.header-main__menu-left li a[href='VanS.aspx']:visited {
    color: red;
}
  ...
  <div class="header-main__banner">
    ...
    <main>
        <div class="title-content">
          <h3 class="title-content__product">Giày VanS</h3>          
