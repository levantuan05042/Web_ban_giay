...
<%@ Page Title="" Language="C#" MasterPageFile="~/Sites/Site1.Master" AutoEventWireup="true" CodeBehind="Jordan.aspx.cs" Inherits="BTVN_LeVanTuan.WebForms.Jordan" %>
...
/* ----------- End Footer ---------- */
.header-main__menu-left li a[href='Jordan.aspx']:visited {
    color: red;
}
  ...
  <div class="header-main__banner">
    ...
    <main>
        <div class="title-content">
          <h3 class="title-content__product">Giày Jordan</h3>          
